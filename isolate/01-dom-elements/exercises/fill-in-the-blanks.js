...
_4_element.innerHTML = 'party palace';
...
const _5_test = _5_element.nodeName === 'P';
console.assert(_5_test, 'Test 5');

const _6_element = document.createElement('textarea');
_6_element.value = 'many many mumbling mice';
const _6_test = _6_element.value === 'many many mumbling mice';
